    ...
    export default {
        ...
        methods: {
            ...
            async getRecommendSong() {
                ...
                if (res.code === ERR_OK) {
                    let songList = []
                    res.data.dailySongs.forEach((item) => { // 循环数组对象对每个数据进行处理 返回需要得数据
...
<style lang="stylus" scoped>
    ...
    .recommend-container>>>.song-list-container,
    .recommend-container>>>.songs-sheet-list-container {
        padding-top: 0.3rem;
    }
    ...
    .recommend-container>>>.van-tabs__content .van-tabs__track,
    .recommend-container>>>.van-tabs__content .van-tab__pane {
        position: absolute;
        top: 0;
        bottom: 0;
    }
