    ...
    <div class="singer-list-item">
      <div class="left">
        ...
        <article class="singer-info">
          ...
          <div class="info">
            <span v-if="_singer.songSize" class="songSize">单曲:{{_singer.songSize}}</span>
            <span v-if="_singer.albumSize" class="albumSize">专辑:{{_singer.albumSize}}</span>
      ...
      <div class="right" v-if="showFollow">
        <!-- 收藏 -->
        <follow @clickFollow="handleClickFollow" plain :followed="_singer.followed"></follow>
      </div>
    </div>
  </div>
