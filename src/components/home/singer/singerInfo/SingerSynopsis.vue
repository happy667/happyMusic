<template>
  ...
  <div class="singer-synopsis-container">
    ...
    <template v-if="singer">
      <!-- 歌手图片 -->
      <div class="singer-img" @click="handleClick">
        <div id="image" class="animated fadeIn">
          <van-image :src="singer.picUrl" class="animated fadeIn" fit="cover">
...
<div class="singer-synopsis">
    <!-- 粉丝数量 -->
    <p class="follows" v-if="followeds">{{followeds|convertCount}}粉丝</p>
    <!-- 歌手名称 -->
