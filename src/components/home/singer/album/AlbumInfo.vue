  ...
  <div class="album-container">
    ...
    <div class="album-header"
      ...
      <section class="album-info"
        ...
        <!-- 背景 -->
        <div class="bg"
             v-lazy:background-image="albumObj.album.blurPicUrl"
             v-if="albumObj.album.blurPicUrl"></div>
      </section>
    </div>
          ...
          <div class="album-desc"
            ...
            <section class="content">
              <van-skeleton title
                            :row="2"
                            title-width="30%"
                            :loading="!albumObj.album"
                            row-width="100%">
                <p>简介:</p>
                <p v-if="albumObj.album"
                   v-html="albumObj.album.description"></p>
              </van-skeleton>
            </section>
          </div>
